...
(function () {
    ...
    describe('Todo Controller', function () {
        ...
        beforeEach(inject(function ($controller, $rootScope, $q) {
            scope = $rootScope.$new();
            q = $q;
            ctrl = $controller('TodoCtrl', { $scope: scope, todoService: todoService });
        }));
        ...
        describe('having some saved Todos', function () {
            ...
            it('should save Todos to service', function () {
                expect(todoService.todos.length).toBe(5);
            });
